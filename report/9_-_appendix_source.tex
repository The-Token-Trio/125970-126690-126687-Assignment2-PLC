...
\midrule
Aye Khin Khin Hpone (Yolanda Lim) & st125970 & Static typing rules; type checking; assignment, if, while, function, and \texttt{print()} execution; unary minus inference; pipeline integration (\texttt{pipeline.py}); automated test suite (75 tests) \\
