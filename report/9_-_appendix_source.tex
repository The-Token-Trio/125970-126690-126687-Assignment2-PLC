...
\midrule
Aye Khin Khin Hpone (Yolanda Lim) & st125970 & Static typing rules; type checking; assignment, if, while, function, and \texttt{print()} execution; unary minus inference; pipeline integration (\texttt{pipeline.py}); automated test suite (73 tests) \\
...
\lstinputlisting[style=appendix,
  caption={tests/test\_pipeline.py --- automated regression suite (73 tests)},
  label={lst:tests}
