...
\midrule
Aye Khin Khin Hpone (Yolanda Lim) & st125970 & Static typing and type checking; tree-walking interpreter (assignment, if, while, function, \texttt{print()}); unary minus inference/execution; Desktop UI; CLI; pipeline integration; automated testing (75 tests) \\
