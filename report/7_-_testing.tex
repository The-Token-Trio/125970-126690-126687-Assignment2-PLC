...
Arithmetic expressions were tested with integer-only and mixed integer--float
programs to verify operator precedence and numeric promotion. The expression
\texttt{x + y * 2} confirmed that multiplication binds more tightly than
addition, and mixed-type operands consistently produced \texttt{Float} results
in accordance with the promotion rules defined in Chapter~5.
