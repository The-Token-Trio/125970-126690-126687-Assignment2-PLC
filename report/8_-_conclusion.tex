...
The 45 automated tests cover all four pipeline stages --- lexical analysis, parsing,
static type checking, and full pipeline execution --- and confirm correct behaviour
for all language features including scope isolation, unary negation, division
type rules, and error detection. These checks provide a baseline for future extensions.
