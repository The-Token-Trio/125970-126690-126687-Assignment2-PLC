...
parsing appears in Chapters~5 and~6; Chapter~3 presents the type-inference rules
...
described in Chapter~3. It traverses the AST before execution, uses the symbol
