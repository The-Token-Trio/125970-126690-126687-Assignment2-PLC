...
\caption{Data flow from source characters to output. The type checker builds
the symbol table to record and validate types; the interpreter runs only after
the AST passes type checking. All stages are orchestrated through
\texttt{pipeline.py}.}
