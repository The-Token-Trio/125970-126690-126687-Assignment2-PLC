...
\begin{subfigure}[t]{0.48\textwidth}
  ...
  \caption{AST tab (Stage~3).}
  \label{fig:ui-ast}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.48\textwidth}
  \includegraphics[width=\linewidth]{figures/ui-types.png}
  \caption{Type Table tab (Stage~4).}
  \label{fig:ui-types}
\end{subfigure}
...
\begin{subfigure}[t]{0.48\textwidth}
  ...
  \label{fig:ui-error}
\end{subfigure}
\caption{Desktop workbench --- five of the six output tabs shown. The Parse Tree tab (Stage~2) is described in the text. Errors are reported in the
...
\begin{subfigure}[t]{0.48\textwidth}
  ...
  \caption{Stage~4 type table and Stage~5 output.}
  \label{fig:cli-exec}
\end{subfigure}
