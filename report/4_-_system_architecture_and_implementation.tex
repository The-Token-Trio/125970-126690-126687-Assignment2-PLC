...
The system follows a four-stage execution pipeline, with an additional
parse-tree rendering view exposed after parsing for inspection. Lexical and syntactic processing are
...
\textbf{Stage 2 --- Parser output (textbook-style parse tree):}
\begin{lstlisting}
program
    statement
        assignment
...
textbook-style parse tree preserves the concrete operator spellings
...
\begin{itemize}
  ...
  \item \textit{Parse Tree} --- a textbook-style concrete syntax rendering of
...
\begin{subfigure}[t]{0.48\textwidth}
  ...
  \label{fig:ui-error}
\end{subfigure}
\caption{Desktop workbench --- six output tabs. Errors are reported in the
