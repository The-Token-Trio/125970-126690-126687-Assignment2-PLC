...
\textit{Ran \textless{}filename\textgreater{}} after a successful run on a loaded script file or
\textit{Ran editor contents} when running the built-in editor program directly, or
