...
\emph{Note: in the Caml~Light-style design used by this implementation, integer
and float arithmetic use separate operators.  The equivalent program using
the actual language syntax is:}
