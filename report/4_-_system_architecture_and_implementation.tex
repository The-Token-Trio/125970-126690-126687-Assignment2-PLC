...
ASSIGN         '='      line 2, col 3
FLOAT_LITERAL  '20.5'   line 2, col 5
SEMICOLON      ';'      line 2, col 9
PRINT          'print'  line 3, col 1
LPAREN         '('      line 3, col 6
IDENTIFIER     'x'      line 3, col 7
PLUS           '+'      line 3, col 9
IDENTIFIER     'y'      line 3, col 11
...
\midrule
\texttt{x}       & \texttt{Integer} \\
\texttt{y}       & \texttt{Float}   \\
\texttt{x + y}   & \texttt{Float} \quad (Integer $\times$ Float $\rightarrow$ Float) \\
\bottomrule
\end{tabular}
\end{table}
