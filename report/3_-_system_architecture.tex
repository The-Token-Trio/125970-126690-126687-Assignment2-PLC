...
\texttt{Boolean}. Following the language specification, both operators require
two arithmetic (\texttt{Integer} or \texttt{Float}) operands. Comparisons
involving \texttt{Boolean} or \texttt{String} operands are rejected by the type
checker.
