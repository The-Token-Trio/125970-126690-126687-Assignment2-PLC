...
\texttt{+}, \texttt{-}, or \texttt{*}, the result is \texttt{Float}. Any
...
sample programs use \texttt{flag!=false}. Comparisons involving \texttt{String}
operands are rejected (so string equality is not part of the type system).
