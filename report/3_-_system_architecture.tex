...
Recursive functions are intentionally outside the scope of this assignment
implementation. The current language focuses on value parameter passing and
first-call-based function type inference; supporting recursion would require
fixed-point inference or explicit recursive type signatures, which are beyond
the required project features.
